...
<body>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="header-text">
                        <h2>hi <span>,</span> i am <br> nirajan <br> adhikari <span>.</span> </h2>
                        <p>chef de partie</p>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-offset-1 col-sm-5">
                        <div class="single-about-img">
                            <img src="{{ asset('storage/images/about/nirajan.jpg') }}" alt="profile_image">
                ...
                <div class="portfolio-content">
                    <div class="isotope">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="item">
                                    <img src="{{ asset('storage/images/portfolio/p1.jpg') }}"
                                        alt="portfolio image" />
                                ...
                                <div class="item">
                                    <img src="{{ asset('storage/images/portfolio/p2.jpg') }}"
                                        alt="portfolio image" />
                                    <div class="isotope-overlay">
                                        <a href="#">
                                            ui/ux design
                            ...
                            <div class="col-sm-4">
                                <div class="item">
                                    <img src="{{ asset('storage/images/portfolio/p3.jpg') }}"
                                        alt="portfolio image" />
                                    <div class="isotope-overlay">
                                        <a href="#">
                                            web design
                            ...
                            <div class="col-sm-4">
                                <div class="item">
                                    <img src="{{ asset('storage/images/portfolio/p4.jpg') }}"
                                        alt="portfolio image" />
                                    <div class="isotope-overlay">
                                        <a href="#">
                                            web development
        ...
        <div class="clients-area">
            <div class="container">
                <div class="owl-carousel owl-theme" id="client">
                    <div class="item">
                        <a href="#">
                            <img src="{{ asset('storage/images/clients/c1.png') }}" alt="brand-image" />
                        </a>
                    </div><!--/.item-->
                    <div class="item">
                        <a href="#">
                            <img src="{{ asset('storage/images/clients/c2.png') }}" alt="brand-image" />
                        </a>
                    </div><!--/.item-->
                    <div class="item">
                        <a href="#">
                            <img src="{{ asset('storage/images/clients/c3.png') }}" alt="brand-image" />
                        </a>
                    </div><!--/.item-->
                    <div class="item">
                        <a href="#">
                            <img src="{{ asset('storage/images/clients/c4.png') }}" alt="brand-image" />
                        </a>
                    </div><!--/.item-->
                    <div class="item">
                        <a href="#">
                            <img src="{{ asset('storage/images/clients/c5.png') }}" alt="brand-image" />
                        </a>
                    </div><!--/.item-->
                    <div class="item">
                        <a href="#">
                            <img src="{{ asset('storage/images/clients/c6.png') }}" alt="brand-image" />
                        </a>
                    </div><!--/.item-->
                    <div class="item">
                        <a href="#">
                            <img src="{{ asset('storage/images/clients/c7.png') }}" alt="brand-image" />
                        </a>
                    </div><!--/.item-->
                </div><!--/.owl-carousel-->
            </div><!--/.container-->
    ...
    <!-- bootsnav js -->
    <script src="{{ asset('/js/bootnav.js') }}"></script>
    ...
    <!--owl.carousel.js-->
    <script src="{{ asset('/js/owl.jquery.carousel.min.js') }}"></script>
